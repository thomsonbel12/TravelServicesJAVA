...
<body>
	...
	<div id="app" class="app__main">
				...
				<div class="app__header-user">
					...
					<div class="app__header-user-menu">
						...
						<div class="user-menu-option">
							<ul>
								<li onclick="location.href='/ProjectTravelServices/cartdetail'"><i class="fa-solid fa-list"></i> <!-- <a href="">Đơn đặt chỗ của tôi</a> -->
		...
		<div class="app__body">
								...
								<button
									...
									<div class="search-item search-right-content">
										<div class="search-type-display">
											<input name="search_type" class="search-input-type-num" style="display: none;"
												type="number"> <span
			...
			<c:forEach items="${listSearchHotels}" var="o">
				<div style="margin: 5px;" id="search_infomation">
					<div class="searched_item">
						<div class="images_of_searched_item">
							<div class="main_image">
								<img style="width: 570px; max-height: 380px;"
									src="${o.getImage1()}" alt="">
							</div>
							<div class="other_images">
								<img style="height: 90px; width: 136px;" class="image_item"
									src="${o.getImage2()}" alt=""> <img
									style="height: 90px; width: 136px;" class="image_item"
									src="${o.getImage3()}" alt=""> <img
									style="height: 90px; width: 136px;" class="image_item"
									src="${o.getImage4()}" alt=""> <img
									style="height: 90px; width: 136px;" class="image_item"
									src="${o.getImage5()}" alt="">
							</div>
						</div>
    ...
    <script>
        ...
        document.getElementById("hotel-category").addEventListener('click', hotelCategoryClick);
        ...
        document.getElementById("house-category").addEventListener('click', houseCategoryClick);
        ...
        document.getElementById("xxx0-category").addEventListener('click', xxx0CategoryClick);
        ...
        document.getElementById("xxx1-category").addEventListener('click', xxx1CategoryClick);
        ...
        document.getElementById("xxx2-category").addEventListener('click', xxx2CategoryClick);
        ...
        document.getElementById("xxx3-category").addEventListener('click', xxx3CategoryClick);
    ...
    <script>
        const searchFormClick = document.querySelectorAll('.content-item-input-text');
        const ShowSearchForm = document.querySelectorAll('.item-input-search-wrap');
    ...
    <script>
        const AddFormClick = document.querySelectorAll('.input-people-room-text');
    ...
    <script>
        const search_type_display = document.getElementsByClassName('search-type-display');
        const search_type_select = document.getElementsByClassName('search-type-select');
        for (let index = 0; index < search_type_display.length; index++) {
        ...
        const search_input_input = document.querySelectorAll('.search-input input');
        const search_input_type = document.querySelector('.search-input-type');
        const search_input_type_num = document.querySelector('.search-input-type-num')
        ...
        for (let i = 0; i < select_type.length; i++) {
            select_type[i].addEventListener('click', function () {
                ...
                search_input_input[0].placeholder = select_type[i].innerHTML.trim() 
