    ...
    <div id="app" class="app__signup ">
        <header class="app__header">
            ...
            <div class="app__header-getin">
                <div class="app__header-signup">
                    <button onclick="location.href='/ProjectTravelServices/loginlandlord'" class="app__header-button" type="button">
                ...
                <div class="app__header-signin">
                    <button onclick="location.href='/ProjectTravelServices/signuplandlord'" class="app__header-button">
        ...
        <div class="app__body signup-app">
            <div class="app__body-card signup-card">
                <h1 class="app_body-header">Đăng ký <span class="rgbRed-text">Với tư cách Chủ Nhà</span></h1>
                <p>Vui lòng nhập đúng thông tin đăng nhập để có thể đăng ký tài khoản</p>
                <div class="app__body-signup-method">
                    <ul class="app__body-signup-method-list">
                        <li class="app__body-signup-email app__body_signup-select">
                            <button id="btn-email-signup" class="app__body-signup-btn app__body-signup-btn-email"
                                    onclick="email_signup()">
                                EMAIL
                            </button>
                        </li>
                        <li class="app__body_signup-phone app__body_signup-select">
                            <button id="btn-phone-signup" class="app__body-signup-btn app__body-signup-btn-phone"
                                    onclick="phone_signup()">
                                DI ĐỘNG
                            </button>
                        </li>
                    </ul>
                ...
                <div class="app__body-card-form">
					...
					<form id="app__body-card-email" class="app__body-input"
						action="signuplandlord" method="post">
						...
						<c:if test="${signup_landlord_error!=null}">
							<div class="login-error" style="display: flex;">
								<i class="fa-sharp fa-solid fa-circle-exclamation"></i>
								<p class="error">${signup_landlord_error}</p>
							</div>
						</c:if>
