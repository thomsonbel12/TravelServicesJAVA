...
public class Constant {
	...
	public static final String redirectUrl="http://localhost:8080/ProjectTravelServices/paywithmomo";
	public static final String ipnUrl="http://localhost:8080/ProjectTravelServices/paywithmomo";
