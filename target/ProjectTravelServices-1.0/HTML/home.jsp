			...
			<div class="search-container">
				<div class="search-container-text">
                    ...
                    <div style="display: none;">
                        <h2>Số khách: <span class="max_adult_num">100</span> người lớn, <span class="max_child_num">100</span> trẻ em</h2>
                        <h2>Giá: 288.150 VND</h2>
                        <h2>Số phòng còn trống :
                            <span class="max_available_num">100</span></h2>
                                        ...
                                        <div class="input-add-room-people">
                                            <div class="input-add add-room">
                                                ...
                                                <div class="input-add-btn">
                                                    <i
                                                            class="fa-regular fa-square-minus minusRoom"></i>
                                            ...
                                            <div class="input-add add-adult">
                                                ...
                                                <div class="input-add-btn input-add-btn-adult">
                                                    <i id="minusAdult"
                                                       class="fa-solid fa-square-minus minusAdult"></i>
                                                    <span id="adults" class="input-add-number adults">1</span>
                                                    <i id="addAdult"
                                            ...
                                            <div class="input-add add-child">
                                                ...
                                                <div class="input-add-btn">
                                                    <i id="minusChild"
                                                       class="fa-regular fa-square-minus minusChild"></i>
                                                    <span class="input-add-number children">0</span>
                                                    <i id="addChild"
